          ...
          <Box style={{ display: 'flex', height: '100vh' }}>
            ...
            <Flex direction="column" gap="2" height={'100vh'}>
              ...
              {((this.props.taskId === 11 && this.props.img && this.props.img !== '' && this.props.isTraining===1) &&
                <img src={this.props.img} alt={`No plots yet`} onLoad={() => {}/*URL.revokeObjectURL(this.props.img)*/} style={{ position: 'absolute', bottom: 150, left: 660, height: '200px', width: 'auto' }}/>
              )}

              {((this.props.taskId === 11 && this.props.img && this.props.img !== '' && this.props.isTraining===2) &&
                <img src={this.props.img} alt={`No plots yet`} style={{ position: 'absolute', bottom: 150, left: 660, height: '200px', width: 'auto' }}/>
              )}
