...
class TaskDescriptionSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('pk', 'task_id', 'name', 'short_description', 'description', 'type', 'dataset', 'n_inputs', 'n_outputs', 'max_epochs', 'max_layers', 'max_nodes', 'normalization_visibility', 'iterations_slider_visibility', 'lr_slider_visibility')
